...
const Service = () => {
  ...
  return (
    <div>
      ...
      <section className='max-w-screen-xl lg:my-10 mx-auto w-full overflow-hidden lg:rounded-2xl py-16 md:py-10 items-center justify-center bgcssa' style={{ backgroundImage: `url('${BackgroundImage}')`, objectFit: "cover", }}>
        <div className=''>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-4'>
              <div className='w-full h-64 overflow-hidden rounded-md shadow-lg shadow-black py-8 px-5 bg-white'>
                ...
                <div className='font-bold text-xl text-[#DC143C] py-4 flex items-center gap-x-4'>
                  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="animate-pulse" height="28" width="28" xmlns="http://www.w3.org/2000/svg"><path d="M256 160c-52.9 0-96 43.1-96 96s43.1 96 96 96 96-43.1 96-96-43.1-96-96-96zm246.4 80.5l-94.7-47.3 33.5-100.4c4.5-13.6-8.4-26.5-21.9-21.9l-100.4 33.5-47.4-94.8c-6.4-12.8-24.6-12.8-31 0l-47.3 94.7L92.7 70.8c-13.6-4.5-26.5 8.4-21.9 21.9l33.5 100.4-94.7 47.4c-12.8 6.4-12.8 24.6 0 31l94.7 47.3-33.5 100.5c-4.5 13.6 8.4 26.5 21.9 21.9l100.4-33.5 47.3 94.7c6.4 12.8 24.6 12.8 31 0l47.3-94.7 100.4 33.5c13.6 4.5 26.5-8.4 21.9-21.9l-33.5-100.4 94.7-47.3c13-6.5 13-24.7.2-31.1zm-155.9 106c-49.9 49.9-131.1 49.9-181 0-49.9-49.9-49.9-131.1 0-181 49.9-49.9 131.1-49.9 181 0 49.9 49.9 49.9 131.1 0 181z"></path></svg>
                  Solar Panel Installation
                </div>
                <p className='text-black pb-4'>
                  Harness the power of the sun with our expert solar solutions.
                </p>
                <Link to="/portfolio" className=" overflow-hidden hover:font-semibold text-nowrap text-[#DC143C]">
                  <span className="text-nowrap flex justify-start items-center font-semibold hover:gap-x-4">
                    View More 
                    <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="ln_more" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="9 18 15 12 9 6"></polyline></svg>
                  </span>
                </Link>
              </div>
              <div className='w-full h-64 overflow-hidden rounded-md shadow-lg shadow-black py-8 px-5 text-white servicedivbg'>
                ...
                <div className='font-bold text-[orange] text-xl py-4 flex items-center gap-x-4'>
                  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" height="28" width="28" className='animate-pulse' xmlns="http://www.w3.org/2000/svg"><path d="M296 160H180.6l42.6-129.8C227.2 15 215.7 0 200 0H56C44 0 33.8 8.9 32.2 20.8l-32 240C-1.7 275.2 9.5 288 24 288h118.7L96.6 482.5c-3.6 15.2 8 29.5 23.3 29.5 8.4 0 16.4-4.4 20.8-12l176-304c9.3-15.9-2.2-36-20.7-36z"></path></svg>
                  Electrical Repairs and Installation
                </div>
                <p className='text-white pb-4'>
                  safe and efficient wiring, lighting and power solutions
                </p>
                <Link to="/portfolio" className=" overflow-hidden hover:font-semibold text-nowrap text-[orange]">
                  <span className="text-nowrap flex justify-start items-center font-semibold hover:gap-x-4">
                    View More 
                    <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="ln_more" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="9 18 15 12 9 6"></polyline></svg>
                  </span>
              ...
              <div className='hidden md:block w-full h-64 overflow-hidden rounded-md shadow-lg shadow-black py-8 px-5 bg-white'>
                ...
                <div className='font-bold text-xl text-[#DC143C] py-4 flex items-center gap-x-4'>
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" stroke="currentColor" fill="currentColor" stroke-width="0" className='animate-pulse' viewBox="0 0 50 50">
