...
import BackgroundImage1 from "../images/our_electric_service.jpg";
...
const HomePage = () => {
  ...
  const slideData = [
    { url: BackgroundImage, caption: 'A RAY OF HOPE WITH SOLAR ENERGY SOLUTIONS FOR A SUSTAINABLE TOMORROW', energy: "Solar Energy", style: { color: "#f3a61a" }, },
    { url: BackgroundImage1, caption: 'SPARK INNOVATION BY UNLEASHING THE POTENTIAL ENERGY WITH ADVANCED TECHNOLOGY', energy: "Electric Energy", style: { color: "#DC143C" }, },
    { url: BackgroundImage2, caption: 'PIPE DREAM TO REALITY VIA DELIVERING EFFICIENT PLUMBING SOLUTIONS FOR A BETTER WORLD', energy: "Pipe Synergy", style: { color: "#26d367" }, },
  ];
  ...
  return (
    <div className='my-auto'>
      <Navbar />
      <section className='max-w-screen-xl lg:my-10 mx-auto w-full overflow-hidden lg:rounded-2xl py-16 items-center justify-center bgcss' style={{ backgroundImage: `url('${slideData[currentIndex].url}')` }}>
        <div className='flex items-center justify-between px-6 lg:px-20'>
          ...
          <div className='flex flex-col text-white gap-y-2 md:gap-y-3 lg:gap-y-4 py-8 font-semibold'>
            <Link className='hover:font-bold hover:text-[#DC143C] cursor-pointer'to="/" style={slideData[currentIndex].style}>Home</Link>
        ...
        <div className='py-4 px-4 md:px-6 lg:px-20'>
          <span className='rounded-full bg-[#ffffff3b] px-7 py-2 font-medium italic' style={slideData[currentIndex].style}>{slideData[currentIndex].energy}</span>
          ...
          <Link to="/portfolio" className='rounded-r-full bg-white px-7 py-2 font-bold cursor-pointer hover:italic' style={slideData[currentIndex].style}>Our Portfolio</Link>
        </div>
      ...
      {/* about us */}
      <section className='max-w-screen-xl mx-auto w-full overflow-hidden lg:rounded-2xl py-6 px-6 lg:px-20 items-center justify-center bg-backgroundText'>
        <div>
